...
This document helps you plan your 4-tier subscription system (Free → Tier 1 → Tier 2 → Tier 3).

---

## 🎯 Feature Categories for Subscription Planning

### 1. MEETING DURATION & FREQUENCY
**Current State:** Unlimited
- ✅ Instant meetings (unlimited)
...
- ✅ Participant capacity setting (host-controlled)
- ✅ No enforced platform-wide limit
...
- ✅ Meeting duration: 40 minutes max
- ✅ Participants: 5 max
- ✅ Meetings/month: 10 max
- ✅ View modes: Gallery only
- ✅ Chat: Text only, 7-day history
- ✅ Screen share: Basic quality
- ❌ No recording
- ❌ No background effects
- ❌ No scheduling
- ❌ No user uploads
- ✅ Basic security (invites, passcodes)

---

### TIER 1 (BASIC/PRO)
**Target:** Small teams, regular users
- ✅ Meeting duration: 2 hours max
- ✅ Participants: 25 max
- ✅ Meetings/month: 50 max
- ✅ View modes: Gallery + Speaker
- ✅ Chat: Full chat + file sharing
- ✅ Screen share: HD quality
- ✅ Recording: Basic (1 hour max, lower quality)
- ✅ Background effects: Blur + 5 virtual backgrounds
- ✅ Scheduling: Basic (no recurring)
- ✅ Storage: 1GB
...
- ✅ Meeting duration: 8 hours max
- ✅ Participants: 100 max
- ✅ Meetings/month: Unlimited
- ✅ View modes: All modes
- ✅ Chat: Full + extended history
- ✅ Screen share: HD + audio capture
- ✅ Recording: HD (unlimited duration, cloud storage)
- ✅ Background effects: All + user uploads (10GB)
- ✅ Scheduling: Full + calendar sync
- ✅ Storage: 10GB
...
- ✅ Meetings/month: Unlimited
- ✅ View modes: All + custom layouts
- ✅ Chat: Unlimited + advanced features
- ✅ Screen share: All features + remote control
- ✅ Recording: Unlimited HD + advanced features
- ✅ Background effects: All + unlimited uploads + premium library
- ✅ Scheduling: Advanced + integrations
- ✅ Storage: Unlimited
- ✅ Full admin controls
- ✅ Team management
- ✅ Analytics & reporting
